...
\begin{multicols*}{3}
    ...
    Overriding allows child class to change the inherited method behaviour.
    ...
    its method is invoked depending run-time type.
    \begin{lstlisting}[showstringspaces=false, language=Java, xleftmargin=-.3in]
    ...
    \textbf{Checked}: an exception that a programmer has no control over with despite
    ...
    \begin{mdframed}
        \section{26 - 27. Wildcards \& Type Inference}
    \end{mdframed}
